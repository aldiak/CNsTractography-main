...
def task_trk2binary1(file,out_file,ref_path):
...
if __name__ == '__main__':
    ...
    base_dir="/mnt/disk1/testset"
    # Find all subject directories (e.g., sub-102715, sub-100610, etc.)
    subjects = [d for d in glob.glob(os.path.join(base_dir, 'sub-*')) if os.path.isdir(d)]
...
# python trk2bin.py --tract_dir /home/alou/Downloads/ISBI2023-One-Shot-WM-Tract-Segmentation-main/HCP105_Zenodo_NewTrkFormat --ref_dir /mnt/disk1/ISBI2023_data/data/